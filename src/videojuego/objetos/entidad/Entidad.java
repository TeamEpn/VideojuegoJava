    ...
    public Object[] verificarColision(Objeto col) {
        ...
        if (col.getTag().compareToIgnoreCase(Objeto.Tag.ENEMIGO) == 0) {
            ...
            if (lados_ente[0].intersects(lados_col[0])) {
                //"arriba";
                obj_colision = col;
                direccion = "entorno_arriba";
            } else if (lados_ente[1].intersects(lados_col[0])) {
                //"derecha";
                obj_colision = col;
                direccion = "entorno_derecha";
            } else if (lados_ente[2].intersects(lados_col[0])) {
                //"abajo";
                obj_colision = col;
                direccion = "entorno_abajo";
